...
class PoemsControllerTest < ActionController::TestCase
  ...
  test "should create poem" do
    assert_difference('Poem.count') do
      post :create, poem: { author: @poem.author, content: @poem.content, title: @poem.title, type: @poem.type }
    end
  ...
  test "should update poem" do
    patch :update, id: @poem, poem: { author: @poem.author, content: @poem.content, title: @poem.title, type: @poem.type }
    assert_redirected_to poem_path(assigns(:poem))
  end
